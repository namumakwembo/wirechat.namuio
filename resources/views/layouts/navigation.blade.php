...
<section x-data="{ sideBarFloating: false }"   class=" z-50  w-full px-8 text-gray-700 bg-white dark:bg-zinc-950 body-font" >
    ...
    <div class="  flex items-center justify-between py-5 mx-auto ">
        ...
        <div class="flex lg:hidden">
            <button x-cloak @click="sideBarFloating = !sideBarFloating" type="button" class="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-hidden focus:text-gray-600 dark:focus:text-gray-400" aria-label="toggle menu">
...
<aside x-cloak :class="[sideBarFloating ? 'translate-x-0 opacity-100 flex ' : ' opacity-0  -translate-x-full']"
    ...
    <div x-cloak x-show="sideBarFloating" class="flex lg:hidden flex-col gap-5 px-3 ">
     ...
     <nav  class=" gap-5 flex flex-col ">
         <a href="{{route('docs')}}" class=" font-medium   px-3 py-px rounded-xl text-gray-600 dark:text-gray-200 transition duration-150 ease-out hover:text-gray-900 dark:hover:text-gray-300 {{ request()->routeIs('docs')?'dark:bg-blue-400/60 bg-blue-500/60 hover:text-white text-white ':'' }}">
              Documentation
         </a>

          <a href="https://github.com/namumakwembo/wirechat" class=" font-medium   px-3 py-px rounded-xl text-gray-600 dark:text-gray-200 transition duration-150 ease-out hover:text-gray-900 dark:hover:text-gray-300">
              Github
         </a>
