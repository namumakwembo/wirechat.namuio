...
<section x-data="{ sideBarFloating: false }"   {{$attributes->merge(['class'=>" z-50  w-full px-6 sm:px-8 border-b dark:border-gray-700 text-gray-700 bg-white dark:bg-zinc-900 body-font"])}} >
