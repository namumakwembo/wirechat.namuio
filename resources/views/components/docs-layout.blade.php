                    ...
                    <div class="mt-auto flex flex-col gap-4 overflow-x-visible">
                        ...
                        <template x-teleport="body">
                            <div x-data={show:false}
                                 class=" hidden md:grid space-y-2  w-52 lg:w-72   fixed inset-x-auto bottom-10 right-10 z-50 group">


                                {{-- Content --}}
                                <div x-cloak x-show="show"
                                     class=" bg-white dark:bg-zinc-900 grid  gap-y-2 border dark:border-gray-700 p-5 shadow-xs rounded-lg">

                                    <h5 class="dark:text-white">Need Help?</h5>
                                    <p class="text-sm">
                                        Check out existing discussions or reported issues , your problem may already
                                        have a solution.
                                        If not, feel free to open a new issue.
                                    </p>

                                    <hr class="dark:border-gray-700">
                                    <a href="https://github.com/namumakwembo/wirechat/issues"
                                       class="dark:bg-gray-800 bg-gray-100 text-black rounded-lg w-full dark:text-white flex items-center gap-3 text-xs text-center self-center px-3 py-2 my-2 mx-2">
                                        <span>
                                    ...
                                    <a href="https://github.com/namumakwembo/wirechat/discussions"
                                       class="bg-black rounded-lg w-full text-white flex items-center gap-3 text-xs text-center self-center px-3 py-2 my-2 mx-2">
                                        <span>
                                    ...
                                    <a href="https://buymeacoffee.com/namuio/e/366303" target="_blank"
                                       class="rounded-lg w-full border dark:border-gray-700 dark:text-white flex items-center gap-2 text-xs text-center self-center px-3 py-2 my-2 mx-2">
                                        <span>
