    ...
    <section class="space-y-10 my-28">
             ...
             <span class="flex items-center gap-3 mex-w-fit ">
               Private 1+1
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                     class="size-6 w-5 h-5 text-blue-500">
        ...
        <x-features-item :reverse="false">
            <x-slot:title>
              <span class="flex items-center gap-3 mex-w-fit ">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="size-6 text-blue-400  w-6 h-6">
            ...
            <x-slot:description>
                ...
                For messages , you can choose to delete only for yourself or for everyone
            </x-slot>
        </x-features-item>
        <x-features-connector/>
        ...
        <x-features-item :reverse="true">
            <x-slot:title>
               <span class="flex items-center gap-3 mex-w-fit ">
                  Group
                  <svg class="shrink-0 w-8 h-7 scale-90 rounded-full text-blue-400 bg-gray-100 dark:bg-gray-600 p-1"
            ...
            <x-slot:description>
                ...
                Convienient for teams or communities looking to create chat rooms
            </x-slot>
        </x-features-item>
        ...
        <x-features-item :reverse="false">
            <x-slot:title>
                ...
                <span class="flex items-center gap-3 mex-w-fit ">
                  Share Media
                   ...
                   <svg class="w-5 h-5 text-blue-500" xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"
                        stroke-linejoin="round" class="ai ai-Attach"><path
                           d="M6 7.91V16a6 6 0 0 0 6 6v0a6 6 0 0 0 6-6V6a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v9.182a2 2 0 0 0 2 2v0a2 2 0 0 0 2-2V8"/></svg>
            ...
            <x-slot:description>
                ...
                with our beatufiul preview layouts , users can easily add more or remove attachemnts before uploading
            </x-slot>
        </x-features-item>
        ...
        <x-features-item :reverse="false">
            ...
            <span class="flex items-center gap-3 mex-w-fit ">
               ...
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-send-check w-5 h-5 text-blue-500 " viewBox="0 0 16 16">
                  <path
            ...
            <x-slot:description>
                Not only will you be able to share send and receives messages in realtime , you will also be able to
                search for private conversations & group chats
            </x-slot>
        </x-features-item>
        ...
        <x-features-item :reverse="true">
            <x-slot:title>
             ...
             <span class="flex items-center gap-3 mex-w-fit ">
               Customizable  Theme
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="size-6 w-5 h-5 text-blue-500">
                  <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <x-slot:description>
                In order to match your brand , you can easily customize the theme in the config and to your brand color
                and wirechat also supports dark mode
            </x-slot>
        </x-features-item>
        ...
        <x-features-item :reverse="false">
            ...
            <x-slot:description>
                You can also reply to messages, files and attachments in the conversation making it convenient and easy
                to follow conversations just like modern chat apps
            </x-slot>
        </x-features-item>
        ...
        <x-features-item :reverse="true">
            ...
            <x-slot:description>
                You can also save messages by creating a conversation with yourself as an authenticated user
            </x-slot>
        </x-features-item>
