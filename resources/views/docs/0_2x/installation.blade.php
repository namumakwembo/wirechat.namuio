<x-docs-layout>
    ...
    <x-markdown>
        ...
        Wirechat is a simple yet robust chat package built with the [TALL Stack](https://tallstack.dev/), making it easy
        to integrate into your Laravel app with just a few commands.
        ...
        * Tailwindcss 3.x|4.x
        ...
        Before installing, ensure that authentication is already set up in your application. You may use any Livewire
        ...
        >⚠️ Beta Notice: Wirechat is currently in beta. While it may not yet be production-ready, we encourage you to
        explore and test it out. If you encounter any issues, your feedback will be invaluable in helping us refine and
        improve the package for a stable release.
        ...
        **Finally** Apply the necessary database migrations with:
        ...
        ```
        **Note:** This package requires the `@tailwindcss/forms` plugin. Make sure it is installed and included in your
        Tailwind config.
        ...
        **Note**: This command will prompt you to install Laravel Reverb and necessary front-end packages such as Echo.
        ...
        For more details, refer to the [Laravel Broadcasting Documentation](https://laravel.com/docs/11.x/broadcasting),
        including information on integrating Laravel Echo for real-time updates.

        #### Step 2: Start Your Queue Worker

        After configuring broadcasting, start a [queue
