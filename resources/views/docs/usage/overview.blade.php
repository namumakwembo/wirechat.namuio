...
<x-section-sub-heading label="Using the WireChat UI" key="Starting Chat Using the WireChat UI" />
...
<x-section-sub-heading label="Creating a Private Chat Programmatically" />
...
<x-section-heading label="User-Specific Chat Creation Permissions" />
...
<x-section-sub-heading label="Via the WireChat UI" key="Sending message via UI" />
...
<x-section-sub-heading label="Sending Programmatically" key="Sending message Programmatically"  />
...
<x-section-sub-heading label="Viewing Conversations:" />
...
<x-section-sub-heading label="Programmatically Fetching Conversations:" />
...
<x-section-sub-heading label="Applying Scopes:" />
